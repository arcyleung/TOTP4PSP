...
int main() {
  ...
  for (i = 0; i < 16; i++) {
    ...
    // pspDebugScreenPrintf(" File path is %s", file);
    ltn[i] = intraFontLoad(file,INTRAFONT_CACHE_ALL);                                             //<- this is where the actual loading happens 
  ...
  // while(1) {
  //   pspDebugScreenPrintf("Loaded %x %x %x \n",ltn[0], ltn[4], ltn[8]);
  // }
  ...
  while(running)  {
    ...
    intraFontSetStyle(ltn[8],2.0f,WHITE,0U,0.f,INTRAFONT_SCROLL_LEFT);
    intraFontSetStyle(ltn[0],2.0f,WHITE,0U,0.f,INTRAFONT_SCROLL_THROUGH);
    intraFontSetStyle(ltn[2],2.0f,WHITE,0U,0.f,INTRAFONT_SCROLL_THROUGH);
    intraFontSetStyle(ltn[4],2.0f,WHITE,0U,0.f,INTRAFONT_SCROLL_THROUGH);
    intraFontSetStyle(ltn[6],2.0f,WHITE,0U,0.f,INTRAFONT_SCROLL_THROUGH);
